...
== Brunch
Brunch is a front end application bundler.  There are many projects that do similar work and all are
options for using with Library Weasel.  I've choosen Brunch since it requires little configuration,
supports Vue, and currently builds much faster from within a Gradle build than webpack.
